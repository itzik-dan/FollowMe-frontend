  ...
  const followUser = async () => {
    ...
    setProfile((prevState) => {
      return {
        ...
        user: {
          ...prevState.user,
          followers: [...prevState.user.followers, data.followingUser._id],
        },
      };
    });
    setLoading(false);
            ...
            <div className="col-md-6">
              <div className="site-card-border-less-wrapper">
                <Card
                  ...
                  style={{ width: 300 }}
                >
                  <h5>Posts: {profile.userPosts.length}</h5> <br />
                  <h5>Followers: {profile.user.followers.length}</h5>
                  <br />
                  <h5>Following: {profile.user.following.length}</h5>
                  <br />
                  {loading ? (
                    <Spin size="large" />
