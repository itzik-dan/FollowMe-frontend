...
const ProfileScreen = ({ history }) => {
  ...
  useEffect(() => {
    if (!userInfo) {
      ...
      (async () => {
        const { data } = await axiosInstance.get(`/mypost`, {
          headers: {
    ...
    <div>
        ...
        <div className="col-md-6">
          <div className="site-card-border-less-wrapper">
            ...
            >
              ...
              <h5>
                {userInfo.followers ? userInfo.followers.length : <Spin />}{" "}
                Followers
              </h5>
              <br />
              <h5>
                {userInfo.following ? userInfo.following.length : <Spin />}{" "}
                followings
              </h5>
              <br />
            </Card>
      ...
      <div className="row mt-5">
        {myPosts.length ? (
          ...
          <h4 className="pl-3">
            No posts yet, <Link to="/create">Click to create new post</Link>
          </h4>
        )}
      </div>
    </div>
